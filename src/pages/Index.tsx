...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A1A2E] via-[#0F3460] to-[#1A1A2E] overflow-y-auto">
      <div className="max-w-6xl mx-auto p-4 pb-32">
        ...
        <Tabs defaultValue="clicker" className="space-y-6 pb-6">
          ...
          <TabsList className="fixed bottom-4 left-1/2 -translate-x-1/2 grid grid-cols-5 gap-2 bg-card/95 backdrop-blur-sm p-2 shadow-2xl border border-primary/20 max-w-3xl w-[95%] z-50">
